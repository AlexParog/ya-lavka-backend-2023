...
/**
 * Класс, представляющий запрос на постраничную выдачу курьеров.
 * <p>
 ...
 */
public class CourierPaginationRequest implements Pageable {
    /**
    ...
    /**
     * Конструктор для создания запроса на постраничную выдачу курьеров.
     *
     * @param offset смещение для постраничной выдачи
     * @param limit  количество записей на странице
     * @param sort   порядок сортировки
     */
    public CourierPaginationRequest(Integer offset, Integer limit, Sort sort) {
        this.offset = offset;
        this.limit = limit;
        this.sort = sort;
    }
